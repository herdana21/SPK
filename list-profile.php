		...
		<div class="card-body">
			<div class="row">
				<div class="form-group col-md-6">
					...
					<input autocomplete="off" type="text" readonly required value="<?php echo $d['nik']; ?>" class="form-control"/>
				</div>

				<div class="form-group col-md-6">
					<label class="font-weight-bold">Nama Lengkap</label>
					<input autocomplete="off" type="text" readonly required value="<?php echo $d['nama']; ?>" class="form-control"/>
				</div>
				<div class="form-group col-md-6">
					<label class="font-weight-bold">email</label>
					<input autocomplete="off" type="text" readonly required value="<?php echo $d['email']; ?>" class="form-control"/>
				</div>
				...
				<div class="form-group col-md-6">
					<label class="font-weight-bold">Foto</sub></label>
					<input autocomplete="off" type="file" name="password" class="form-control"/>
				</div>
